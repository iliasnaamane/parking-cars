...
public class CarResource {
    ...
    public ResponseEntity<BillDTO> deleteCar(@PathVariable Long id, @Valid @RequestBody BillDTO billDTO) {
        log.debug("REST request to delete Car : {}", id);
        BillDTO result = carService.delete(id, billDTO.getNumberHours() ,billDTO.getHourPrice());
